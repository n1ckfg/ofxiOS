...
-(void) lockExposureAndFocusb {
	...
	if( [captureInput.device isFocusModeSupported:AVCaptureFocusModeContinuousAutoFocus] )	[captureInput.device setFocusMode:AVCaptureFocusModeContinuousAutoFocus];
}
